...
import org.unsa.model.dominio.restaurantes.Restaurante; // Importación para Restaurante
import org.unsa.model.dominio.restaurantes.TipoCocina; // Necesario para crear Restaurantes de ejemplo

import java.util.ArrayList;
import java.util.List;
import java.util.logging.Logger;
import java.util.stream.Collectors; // Necesario para Streams
